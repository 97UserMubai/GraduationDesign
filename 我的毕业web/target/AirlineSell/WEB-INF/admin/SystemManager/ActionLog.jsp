                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <table class="datatable table table-hover" cellspacing="0" width="100%">
                            ...
                            <tbody>
                            <c:forEach items="${pageInfo.list}" var="operationLogs">
                                <tr>
                                    <td>${operationLogs.opePerson}</td>
                                    <td>${operationLogs.opeTime}</td>
                                    <td>${operationLogs.opeAction}</td>
                                    <td>${operationLogs.opeAll}</td
                                </tr>
                            </c:forEach>
                            </tbody>
                        </table>
